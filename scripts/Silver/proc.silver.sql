/* ===================================================================
   ...
   Purpose        : Loads and transforms data from Bronze layer tables
                    into Silver layer tables for CRM and ERP datasets.
   Highlights     :
   - Truncates Silver layer tables before inserting fresh data
   - Cleanses, transforms, and standardizes incoming data
